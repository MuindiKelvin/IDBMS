...
<form action="login.php" method="post">
			...
			<font style=" font:bold 44px 'Aleo'; text-shadow:1px 1px 15px #000; color:#fff;"><center>Inventory DBMS</center></font>
		<br>
...
<div class="input-prepend">
	<span style="height:30px; width:25px;" class="add-on"><i class="icon-lock icon-2x"></i></span><input type="password" style="height:40px;" name="password" Placeholder="Password" required/><br>
		...
		<div class="qwe">
		 <button class="btn btn-primary btn-block pull-right" href="dashboard.html" type="submit"><i class="icon-signin icon-large"></i> User Login </button>
		 <!--<button class="btn btn-info btn-block pull-right" href="user/index.php" type="submit"><i class="icon-signin icon-large"></i> Register</button>-->
